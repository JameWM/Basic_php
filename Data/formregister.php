        ...
        <div div class="card-body">
            <form name ="form1" action="insert.php" method="post">
                ...
                <div class="row">
                    ...
                    <textarea class="form-control" name="txt_address" id="txt_address"placeholder="ที่อยู่"></textarea></div>

                    <div class="col-md-6"><br><label for="exampleFormControlInput1" class="form-label" >เบอร์โทร</label>
                    <input  class="form-control" type="text" name="txt_number" id="txt_number"placeholder="เบอร์โทร"></div>
                    <div class="col-md-6"><br><label for="exampleFormControlInput1" class="form-label" >อีเมล์</label>
                    <input  class="form-control" type="text" name="txt_email" id="txt_email"placeholder="อีเมล์"></div>
